...
# repo, so the suite supplies its own throwaway values.
os.environ.setdefault("SECRET_KEY", "test-only-secret-key")
os.environ.setdefault("ENCRYPTION_KEY", "test-only-encryption-key")
os.environ.setdefault("WHATSAPP_BRIDGE_TOKEN", "test-only-bridge-token")
