...
const en = {
  ...
  inbox: {
    ...
    profile: {
      title: "Your profile",
      subtitle: "Your name, your address, your password and your photo. Your department is set by whoever manages the portal.",
      name: "Name",
      email: "E-mail",
      password: "New password",
      passwordHint: "Leave it empty to keep the one you have",
...
const es: typeof en = {
  ...
  inbox: {
    ...
    profile: {
      title: "Tu perfil",
      subtitle: "Tu nombre, tu dirección, tu contraseña y tu foto. Tu dependencia la define quien administra el portal.",
      name: "Nombre",
      email: "Correo",
      password: "Contraseña nueva",
      passwordHint: "Dejala vacía para conservar la que tenés",
